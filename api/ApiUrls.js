...
export const CREATE_ARTICLE_EDIT_VERSION = ApiUrl.build(`${BASE_API_V1_URL}/articles/:id/create-edit-version`)
...
export const UPDATE_PROJECT_ROLES = ApiUrl.build(`${BASE_API_V1_URL}/projects/update-roles`)
